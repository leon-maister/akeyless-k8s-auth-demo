...
2. **Advanced Configuration**: Explain the **Advanced Configuration** settings, focusing on how the Gateway validates the Kubernetes JWT.
   - **Allowed Client Types**: Highlight this security sub-layer. Use our target namespace `akeyless-k8s-python-demo` as a prime example of how to restrict authentication to specific namespaces or service accounts.
